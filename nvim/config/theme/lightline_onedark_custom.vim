...
let s:p.normal.left = [ [ s:black, s:green ], [ s:green, s:white ] ]
let s:p.normal.middle = [ [ s:white, s:black ] ]  "make transparent
let s:p.normal.right = [ [ s:black, s:green ], [ s:green, s:white ] ]
let s:p.normal.warning = [ [ s:black, s:yellow ] ]
let s:p.replace.left = [ [ s:black, s:red ], [ s:white, s:grey ] ]
let s:p.replace.right = [ [ s:black, s:red ], [ s:white, s:grey ] ]
let s:p.tabline.left = [ [ s:purple, s:black ] ]
let s:p.tabline.tabsel = [ [ s:green, s:black ] ]
let s:p.tabline.middle = [ [ s:white, s:black ] ] "make transparent
